...
use App\Http\Controllers\TestCollection\TestController;
...
Route::get('report/{type}', [App\Http\Controllers\ReportController::class, 'index'])->name('report.index');
        ...
        // /*------------TestCollection--------*/
        Route::get('TestColl', [TestController::class, 'index'])->name('TestColl.index');
        Route::get('TestColl/edit/{id}', [TestController::class, 'edit'])->name('TestColl.edit');
        Route::get('TestColl/create', [TestController::class, 'create'])->name('TestColl.create');
        // /*------------EndTestCollection--------*/
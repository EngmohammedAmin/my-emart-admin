<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        {{--  /*------------TestCollection--------*/  --}}
        <li><a class="waves-effect waves-dark" href="{{ route('TestColl.index') }}" aria-expanded="false">
                <i class="mdi mdi-book-open-page-variant"></i>
                <span class="hide-menu">Test Cllection</span>
            </a>
        </li>
        {{--  /*------------EndTestCollection--------*/  --}}
        ...
        <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
            ...
            <ul aria-expanded="false" class="collapse">
                ...
                <li>
                    <a
                        href="{!! url('driverpayments') !!}">{{ trans('lang.driver_plural') }}{{ trans('lang.payment_plural') }}</a>
                </li>

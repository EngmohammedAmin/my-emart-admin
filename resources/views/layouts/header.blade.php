<div class="navbar-header">
    <a class="navbar-brand" href="<?php echo URL::to('/'); ?>">
        <b>
            <img src="{{ asset('/images/logo_web.png') }}" title="{{ config('app.name', 'Laravel') }}" alt="homepage"
                class="dark-logo" width="100%" id="logo_web">
            <img src="{{ asset('images/logo-light-icon.png') }}" title="logo-light-icon " alt="homepage"
                class="light-logo">
        </b>
        <span>
        </span>

                    ...
                    <div class="resttab-sec">
                        ...
                        <div class="menu-tab">
                            <ul>
                                ...
                                <li>
                                    <a
                                        href="{{ route('payoutRequests.drivers.view', $id) }}">{{ trans('lang.tab_payouts') }}</a>
                                </li>
            ...
            ref.get().then(async function(snapshots) {
                ...
                if (dirver.serviceType) {
                    ...
                    if (dirver.serviceType == "cab-service") {
                        ...
                        $('.service_type_orders').html('<a href="' + url +
                            '">{{ trans('lang.rides') }}</a>');
                        ...
                        $('.service_type_orders').html('<a href="' + url +
                            '">{{ trans('lang.rental_orders') }}</a>');

                    } else if (dirver.serviceType == "delivery-service" || dirver.serviceType ==
                        "ecommerce-service") {
                ...
                if (dirver.hasOwnProperty('wallet_amount') && dirver.wallet_amount != null && !
                    isNaN(dirver.wallet_amount)) {
                ...
                if (dirver.profilePictureURL) {
                    image = '<img width="200px" id="" height="auto" src="' + dirver
                        .profilePictureURL + '">';
                } else {
                ...
                if (dirver.hasOwnProperty('userBankDetails')) {
                    ...
                    $('.bank-details').html(
                        '<label class= "col-12 control-label">{{ trans('lang.not_found') }}</label>'
                        );
                }

                    ...
                    <div class="vendor_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-group row width-50">
                                ...
                                <div class="col-12">
                                    <select name="gender_type" id="gender_type" class="form-control gender_type">
                                        <option value="Male"> {{ trans('lang.male') }}</option>
                                        <option value="Famale"> {{ trans('lang.famale') }}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <fieldset>
                                ...
                                <div class="col-12">
                                    <select name="service_type" id="service_type" class="form-control service_type"
                                        ...
                                        <option value="">{{ trans('lang.select') }}
                                            {{ trans('lang.service_type') }}</option>
                            ...
                            <div class="cab_service" style="display: none">
                                ...
                                <div class="form-group row width-50 individualDiv">
                                    ...
                                    <div class="col-7">
                                        <input type="file" onChange="handleFileSelectDriverProof(event)"
                                            class="">
                            ...
                            <div class="rental_service" style="display: none">
                                ...
                                <div class="form-group row width-100 individualDiv" style="display: none">
                                    ...
                                    <div class="col-7">
                                        <input type="file" onChange="handleFileSelectVehicleImages(event)"
                                            class="">
...
@section('scripts')
    <script type="text/javascript">
        ...
        var cab_sections = database.collection('sections').where('serviceTypeFlag', '==', 'cab-service').where('isActive',
            '==', true);
        var serviceType = "";
        var isCompany = false;
        ...
        $(document).ready(function() {
            ...
            ref.get().then(async function(snapshots) {
                ...
                $(".gender_type").val(user.genderType);
            ...
            {{-- var driverAddUrl = '{{route("drivers.create",":id")}}'; --}}
                ...
                if (user.hasOwnProperty('sectionId') && user.sectionId != '') {
                    ...
                    var options =
                        '<option value="">{{ trans('lang.select') }} {{ trans('lang.vehicle_type') }}</option>';
                    refVehicleType.where('sectionId', '==', user.sectionId).get().then(async function(
                        snapshots) {
                        snapshots.docs.forEach((listval) => {
                            var data = listval.data();
                            if (user.hasOwnProperty('vehicleType') && user
                                .vehicleType != '' && data.name == user.vehicleType
                            ) {
                                options += '<option value="' + data.name +
                                    '" data-id="' + data.id + '" selected>' + data
                                    .name + '</option>';
                            } else {
                                options += '<option value="' + data.name +
                    ...
                    if (carInfo.car_image) {
                        if (carInfo.car_image.length > 0) {
                            ...
                            carInfo.car_image.forEach((photo) => {
                                rentalImagesCount++;
                                carPhotoes = carPhotoes +
                                    '<span class="image-item" id="photo_' + rentalImagesCount +
                                    '"><span class="remove-btn" data-id="' + rentalImagesCount +
                                    '" data-img="' + photo +
                ...
                if (user.hasOwnProperty('carProofPictureURL')) {
                    ...
                    if (user.carProofPictureURL != '' && user.carProofPictureURL != null) {
                        ...
                        $(".car_proof").append('<img class="rounded" style="width:50px" src="' + user
                            .carProofPictureURL + '" alt="image">');
                    } else {

                        $(".car_proof").append('<img class="rounded" style="width:50px" src="' +
                ...
                if (user.hasOwnProperty('driverProofPictureURL')) {
                    ...
                    if (user.driverProofPictureURL != '' && user.driverProofPictureURL != null) {
                        ...
                        $(".driver_proof").append('<img class="rounded" style="width:50px" src="' + user
                            .driverProofPictureURL + '" alt="image">');
                    } else {

                        $(".driver_proof").append('<img class="rounded" style="width:50px" src="' +
                            placeholderImage + '" alt="image">');
                    }
                }
                if (user.hasOwnProperty('vehicleType')) {
                ...
                if (carPictureURL != '' && carPictureURL != null) {
                    ...
                    $(".car_image").append('<img class="rounded" style="width:50px" src="' +
                        carPictureURL + '" alt="image">');
                } else {
                ...
                if (photo != '' && photo != null) {
                    $(".user_image").append('<img class="rounded" style="width:50px" src="' + photo +
                        '" alt="image">');
            ...
            $('.cab_section_id').on('change', function() {
                ...
                var options =
                    '<option value="">{{ trans('lang.select') }} {{ trans('lang.vehicle_type') }}</option>';
                refVehicleType.where('sectionId', '==', cab_section_id).get().then(async function(
                    snapshots) {
                    snapshots.docs.forEach((listval) => {
                        var data = listval.data();
                        options += '<option value="' + data.name + '" data-id="' + data
                            .id + '">' + data.name + '</option>';
                    })
                    $(".vehicle_type").html(options);
                });
        ...
        async function getTotalOrders(id, type) {
            ...
            if (type == "cab-service") {
                ...
                await database.collection('rides').where('driverID', '==', id).get().then(async function(
                    orderSnapshots) {
                ...
                await database.collection('rental_orders').where('driverID', '==', id).get().then(async function(
                    orderSnapshots) {
                    count_order_complete = orderSnapshots.docs.length;
                ...
                await database.collection('vendor_orders').where('driverID', '==', driver).get().then(async function(
                    orderSnapshots) {
                    count_order_complete = orderSnapshots.docs.length;
                ...
                url = url.replace("id", id);
                await database.collection('parcel_orders').where('driverID', '==', id).get().then(async function(
                    orderSnapshots) {
                    count_order_complete = orderSnapshots.docs.length;
                        ...
                        uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
                            ...
                            if (downloadURL) {
                                ...
                                photos_html = '<span class="image-item" id="photo_' +
                                    rentalImagesCount + '"><span class="remove-btn" data-id="' +
                                    rentalImagesCount + '" data-img="' + downloadURL +
                                    '"><i class="fa fa-remove"></i></span><img width="100px" id="" height="auto" src="' +
                                    downloadURL + '"></span>';

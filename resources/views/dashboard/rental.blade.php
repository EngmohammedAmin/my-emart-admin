            ...
            <div class="card mb-3 business-analytics">
                ...
                <div class="card-body">
                    ...
                    <div class="row business-analytics_list">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status confirmed" href="{!! route('rental_orders', 'status=order-confirmed') !!}">
                                <div class="data">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status packaging" href="{!! route('rental_orders', 'status=order-shipped') !!}">
                                <div class="data">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status delivered" href="{!! route('rental_orders', 'status=order-completed') !!}">
                                <div class="data">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status canceled" href="{!! route('rental_orders', 'status=order-canceled') !!}">
                                <div class="data">
...
@section('scripts')
    ...
    <script>
        ...
        async function getTotalEarnings() {
            ...
            await db.collection('rental_orders').where('status', 'in', ["Order Completed"]).get().then(async function(
                orderSnapshots) {

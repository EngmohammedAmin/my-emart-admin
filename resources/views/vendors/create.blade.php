                        ...
                        <div class="vendor_payout_create-inner">
                            ...
                            <fieldset id="delivery_charges_div">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row width-100">
                                        <label
                                            class="col-4 control-label">{{ trans('lang.delivery_charges_per_km') }}</label>
                                        <div class="col-7">
...
@section('scripts')
    <script type="text/javascript">
                        ...
                        database.collection('users').doc(user_id).set({
                            ...
                            geoFirestore.collection('vendors').doc(vendor_id).set({
                                ...
                                if (deliveryChargeFlag) {
                                    ...
                                    geoFirestore.collection('vendors').doc(vendor_id)
                                        .update({
                                            'deliveryCharge': deliveryCharge
                                        }).then(async function(result) {

                                            var isSendMail =
                                                await sendRegistrationEmail(user_id,
                                    ...
                                    var isSendMail = await sendRegistrationEmail(user_id,
                                        name, email, phonenumber);
                                    if (isSendMail) {
        ...
        async function sendRegistrationEmail(user_id, name, email, phonenumber) {
            ...
            var sendEmailStatus = await sendEmail(url, emailTemplatesData.subject, emailTemplatesData.message, [
                adminEmail
            ]);
                            ...
                            if (photo) {
                                if (type == 'photo') {
                                    ...
                                    photos_html = '<span class="image-item" id="photo_' +
                                        photocount + '"><span class="remove-btn" data-id="' +
                    ...
                    uploadTask.on('state_changed', function(snapshot) {
                        ...
                        uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
                            ...
                            var html =
                                ...
                                downloadURL + '" width="150px" height="150px;"></div></div>';
                    ...
                    uploadTask.on('state_changed', function(snapshot) {
                        ...
                        uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
                            ...
                            if (photo) {
                                ...
                                menuPhotoCount++;
                                photos_html = '<span class="image-item" id="photo_menu' +
                                    menuPhotoCount +
                                    '"><span class="remove-btn remove-menu-btn" data-id="' +
                                    menuPhotoCount + '" data-img="' + photo +
                                    '"><i class="fa fa-remove"></i></span><img width="100px" id="" height="auto" src="' +
                                    photo + '"></span>';
